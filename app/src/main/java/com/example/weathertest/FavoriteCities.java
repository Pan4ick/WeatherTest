    ...
    private void init(ArrayList<CellModel> cellModels) {
        for (CellModel c : cellModels) {
            if (c.isFavorite()) {
                ...
                main.setLayoutParams(new TableRow.LayoutParams(300, TableRow.LayoutParams.WRAP_CONTENT));
                main.setText(c.getWeather());
                main.setTextSize(12);
                tableRow.addView(main);
                city.setLayoutParams(new TableRow.LayoutParams(300, TableRow.LayoutParams.WRAP_CONTENT));
                city.setText(c.getCity());
                city.setTextSize(12);
                tableRow.addView(city);
                wind.setText(String.format("%,.2f", c.getWind()) + "m/s");
                wind.setTextSize(12);
                wind.setLayoutParams(new TableRow.LayoutParams(150, TableRow.LayoutParams.WRAP_CONTENT));
                tableRow.addView(wind);
                temperature.setText(String.format("%,.2f", c.getTemperature()) + "℃");
                temperature.setTextSize(12);
                main.setLayoutParams(new TableRow.LayoutParams(150, TableRow.LayoutParams.WRAP_CONTENT));
